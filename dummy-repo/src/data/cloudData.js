const gcpProjects = [
  { project: "AI - Common Components", owner: "Isaac Paquette", environment: "prod" },
  { project: "Data Analytics Pipeline", owner: "Sarah Chen", environment: "prod" },
  { project: "ML Training Infrastructure", owner: "Michael Torres", environment: "prod" },
  ...
  { project: "User Authentication Service", owner: "Ryan Foster", environment: "prod" },
...
const awsProjects = [
  ...
  { project: "Batch Processing Jobs", owner: "Nicole White", environment: "prod" },
  ...
  { project: "Redis Cache Layer", owner: "Ashley Walker", environment: "prod" },
  ...
  { project: "Container Registry", owner: "Andrew Wright", environment: "prod" },
...
const azureProjects = [
  ...
  { project: "Database Services", owner: "Tyler Carter", environment: "prod" },
  ...
  { project: "Cosmos DB Cluster", owner: "Dylan Turner", environment: "prod" },
  ...
  { project: "Data Factory Pipeline", owner: "Aria Stewart", environment: "prod" },
